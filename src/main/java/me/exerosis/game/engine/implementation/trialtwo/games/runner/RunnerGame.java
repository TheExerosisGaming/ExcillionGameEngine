...
public class RunnerGame extends Game {
    ...
    public RunnerGame(Plugin plugin, Arena arena, RemoteFolder gameFolder, String name) {
        ...
        BlockDropComponent blockDropComponent = new BlockDropComponent(this, coreComponentBundle.getSpectateComponent(), 3);

        addComponent(GameState.IN_GAME, GameState.POST_GAME, blockDropComponent);
        addComponent(GameState.IN_GAME, GameState.POST_GAME, new AntiCheat(this, coreComponentBundle.getSpectateComponent(), blockDropComponent));
    }
}